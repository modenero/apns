        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-8 xl:col-span-1">
                    <img class="h-10" :src="require('../assets/logo.png')" alt="APNS: Avalanche Push Notification Service" />
                    ...
                    <div class="flex space-x-6">
                        ...
                        <a href="https://twitter.com/ShomariPrince" target="_blank" class="text-warm-gray-400 hover:text-warm-gray-300">
